...
// https://gist.github.com/NaxAlpha/0a6f763010d789d6e720
...
// Program entry point
int doInject(char* exeString, char* workingDir, char* dll, char* dllInitFunction)
{
    ...
    _snprintf(dllPath, MAX_PATH, dll);
    ...
    Inject(pi.hProcess, dllPath, dllInitFunction);
